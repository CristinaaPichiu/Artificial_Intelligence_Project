...
# Renumește coloanele pentru a le face compatibile cu analiza de corelație
...
# Curăță datele și converteste la numeric
data_numeric = data.apply(lambda x: pd.to_numeric(x, errors='coerce'))

# Exclude coloanele care nu sunt numerice (de exemplu, coloana 'ds')
...
# Analizează corelațiile pentru fiecare variabilă
